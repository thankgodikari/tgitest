var config =    {
    ...
    normal_normalDefaultMult: { value: 2.04, type: 'multiplier', label: 'Normal Default Target (Sniper)' },
    ...
    recovery_labouchereMult4Slice: { value: 3.00, type: 'number', label: 'Labouchere: Min Multiplier for 4 Slices' },
    recovery_labouchereMult6Slice: { value: 4.00, type: 'number', label: 'Labouchere: Min Multiplier for 6 Slices' },
