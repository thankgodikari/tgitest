var config =    {
    ...
    testBalanceBits: {value: 300, type: 'number', label: 'Initial test balance (bits)' },
    ...
    wma_timeDecay_halfLife: { value: 5,     type: 'number',      label: 'WMA: Time Decay Half-Life (Rounds)' },
    wma_beta_blend:         { value: 0.18,    type: 'number',      label: 'WMA: Mix Ratio (0.7 = 70% WMA / 30% Bayes)' },

    // 3. Volatility Guard (The Brake)
    wma_vol_window:              { value: 6,     type: 'number',      label: 'WMA: Volatility Scan Window' },
    wma_vol_thresh:              { value: 0.34,   type: 'number',      label: 'WMA: Volatility Threshold (StdDev/Mean)' },
    wma_vol_penalty:             { value: 0.03,   type: 'number',      label: 'WMA: Volatility Penalty (Score Reduction)' }, // Disabled
    ...
    wma_trap_trend_thresh:       { value: 0.25,    type: 'number',      label: 'WMA: Trap Trend Threshold (Score)' },
    wma_trap_penalty:            { value: 0.08,    type: 'number',      label: 'WMA: Trap Detection Penalty (Multiplier)' },
    wma_trap_boost:              { value: 1.2,    type: 'number',      label: 'WMA: Trap Momentum Boost (Multiplier)' },

    // 4. Decision Thresholds (Dynamic Hysteresis)
    wma_threshold_on:       { value: 0.56,   type: 'number',      label: 'WMA: Threshold Ceiling (Start/Max)' },
    wma_threshold_floor:    { value: 0.40,   type: 'number',      label: 'WMA: Threshold Floor (Min)' },
    wma_threshold_step_win: { value: 0.18,   type: 'number',      label: 'WMA: Dyn Thresh Step (Base Win)' },
    ...
    wma_rising_boost:           { value: 3.4,    type: 'number',      label: 'WMA: Rising Trend Boost (Multiplier)' },
    ...
    wma_clusterPenalty:             { value: 0.22, type: 'number', label: 'WMA: Cluster Penalty (multiplicative factor, 0-1)' },
